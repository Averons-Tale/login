document.addEventListener('DOMContentLoaded', function() {
    ...
    const discordOAuthUrl = 'https://discord.com/oauth2/authorize?client_id=1364965268832518154&redirect_uri=https://averon-s-tale-login.firebaseapp.com/__/auth/handler&response_type=code&scope=identify%20email';

    const newWindow = window.open(discordOAuthUrl, '_blank', 'width=800,height=600,scrollbars=yes,resizable=yes');
    
    if (!newWindow || newWindow.closed || typeof newWindow.closed === 'undefined') {
        alert('Bitte stelle sicher, dass Popups in deinem Browser aktiviert sind.');
    }
    });
